...
![Print do Projeto](https://i.imgur.com/xUfN36F.png)
...
```bash
  git clone git@github.com:brunokye/trybe-15-starwars-planets-search.git
```

Entre no diretório

```bash
  cd trybe-15-starwars-planets-search/
```
